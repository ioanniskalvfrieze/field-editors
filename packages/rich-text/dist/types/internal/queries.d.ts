...
export declare const getNodeChildren: (root: Ancestor, path: Path, options?: s.NodeChildrenOptions | undefined) => Generator<p.TNodeEntry<Text | Element | p.TDescendant>, void, undefined>;
...
export declare const getNodeTexts: (root: Node, opts?: {
    ...
    reverse?: boolean;
}) => Generator<p.TNodeEntry<p.TText>, void, undefined>;
...
export declare const createPathRef: (editor: PlateEditor, at: Path) => s.PathRef;
export declare const match: (obj: Node, path: Path, predicate?: p.Predicate<Node> | undefined) => boolean;
